...
export const KOREAN_STOCKS: KoreanStock[] = [
  ...
  // KOSPI ETF
  { code: '069500', name: 'KODEX 200', market: 'KS' },
  { code: '122630', name: 'KODEX 레버리지', market: 'KS' },
  { code: '114800', name: 'KODEX 인버스', market: 'KS' },
  { code: '252670', name: 'KODEX 200선물인버스2X', market: 'KS' },
  { code: '379800', name: 'KODEX 미국나스닥100', market: 'KS' },
  { code: '360750', name: 'KODEX 미국S&P500TR', market: 'KS' },
  { code: '091160', name: 'KODEX 반도체', market: 'KS' },
  { code: '091170', name: 'KODEX 은행', market: 'KS' },
  { code: '102110', name: 'TIGER 200', market: 'KS' },
  { code: '364980', name: 'TIGER 미국S&P500', market: 'KS' },
  { code: '381170', name: 'TIGER 미국나스닥100', market: 'KS' },
  { code: '448540', name: 'KODEX 미국AI반도체나스닥', market: 'KS' },
  { code: '466940', name: 'KODEX 미국빅테크10', market: 'KS' },
  // KOSDAQ ETF
  { code: '229200', name: 'KODEX 코스닥150', market: 'KQ' },
  { code: '232080', name: 'TIGER 코스닥150레버리지', market: 'KQ' },
  { code: '133690', name: 'TIGER 나스닥100', market: 'KQ' },
  // KOSDAQ
